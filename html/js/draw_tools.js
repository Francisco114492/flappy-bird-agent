...
function draw_network(
    ...
    const neuronSize = height / maxNeuronNumInLayer;
    const radius = getRadiusSize(neuronSize);
    ...
    for (
        let layerIdx = 0;
        layerIdx < neuronLocationPerLayer.length;
        layerIdx++
    ) {
        ...
        for (let i = 0; i < locations.length; i++) {
            ...
            const isActive =
                activations[layerIdx] && activations[layerIdx][i] > 0;
